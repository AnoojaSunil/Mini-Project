...
<?php 
            ...
            $query = "select * from book_request br,book b,register r where br.login_id='$myid' and br.book_id=b.book_id and r.login_id=b.login_id and br.req_status='Completed'";
