...
include '../DB_connect.php';
            $query = "select br.login_id, r.name from book_request br,book b,register r where br.req_id='$req_id' and br.login_id=r.login_id";
          ...
          <div class="type_msg">
            <div class="input_msg_write">
                ...
                <input type="hidden" name="req"  value="<?php echo $req_id; ?>"/>
                  ...
                  <button class="msg_send_btn" style="position: absolute;transform: translate(0,-10%);left: 500px;top: 10px;" name="re_chat" type="submit"><i class="fas fa-paper-plane" style="color: #484545;" aria-hidden="true"></i></button>
                </form>
            </div>
