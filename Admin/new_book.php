        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                                ...
                                <h1 class="display-3 text-white animated slideInDown">New Book List</h1>
...
<?php 
            ...
            $query = "select * from book b,register r where b.pub_status='Not' and b.login_id=r.login_id";
       ...
       Mode: <?php echo $data['mode_status'];?></td>
        ...
        <td>
                                <form method="POST" action="account_acion.php">
                                    ...
                                    <button name="btn_pub" type="submit" class="btn-primary">Publish</button>
                                </form>
                                </td>
                                <td class="table_td">
                                <form method="POST" action="account_acion.php">
                                    <input type="hidden" value="<?php echo $data['book_id'];?>" name="b_id">
                                    <button name="btn_pub_rej" type="submit" class="btn-secondary">Reject</button>
                                </form>
                                </td>
    </tr>
