        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                                ...
                                <h1 class="display-3 text-white animated slideInDown">Nonactive Customer List</h1>
...
<?php 
            ...
            $query = "select * from register w,login l where w.login_id=l.login_id and l.status='0'";
