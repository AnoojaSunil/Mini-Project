        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                                ...
                                <h1 class="display-3 text-white animated slideInDown">Rejected Customer List</h1>
...
<?php 
            ...
            $query = "select * from register w,login l where w.login_id=l.login_id and l.status='2'";
      ...
      <td><?php echo $data['email'];?></td>
        ...
        <td>
                                <form method="POST" action="account_acion.php">
                                    ...
                                    <button name="btn_acc" type="submit" class="btn-primary">Approve</button>
                                </form>
                                </td>
                                <td class="table_td">
                                <form method="POST" action="account_acion.php">
                                    <input type="hidden" value="<?php echo $data['login_id'];?>" name="account_id">
                                    <button name="btn_delete" type="submit" class="btn-secondary">Delete</button>
                                </form>
                                </td>
    </tr>
